...
// This is the BASE version. The server expects "v1.0" and will trigger an update to "v1.1".
const String firmwareVersion = "v1.0"; 

const int LED_PIN = 2; // Built-in LED
unsigned long previousBlinkMillis = 0;
const long blinkInterval = 1000; // SLOW BLINK: 1 second
...
void setup() {
  ...
  Serial.println("\n--- Booting Internet OTA Client (BASE VERSION) ---");
...
void loop() {
  ...
  // 1. Non-blocking LED BLINK logic (SLOW)
