...
// the File object should be defined globally and the library's
// internal defined FS object should be set with this global FS object in fileCallback function.
#include <FS.h>
File myFile;
